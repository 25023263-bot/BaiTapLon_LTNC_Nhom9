...
INSERT OR IGNORE INTO physical_items (auction_id, condition_text, weight_grams, dimensions, location, shipping_cost, allow_pickup)
VALUES
...
INSERT OR IGNORE INTO digital_items (auction_id, digital_type, platform, file_size_mb, delivery_content, replacement_guarantee)
VALUES
  (3, 'SOFTWARE_KEY', 'Windows, Mac', NULL, 'XXXX-XXXX-XXXX-DEMO', 1);

INSERT OR IGNORE INTO bids (auction_id, buyer_id, amount, bid_time, auto_bid)
VALUES
...
INSERT OR IGNORE INTO watchlist (buyer_id, auction_id) VALUES (4, 2);
INSERT OR IGNORE INTO watchlist (buyer_id, auction_id) VALUES (4, 3);
INSERT OR IGNORE INTO watchlist (buyer_id, auction_id) VALUES (5, 1);
