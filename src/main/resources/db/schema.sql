...
CREATE TABLE IF NOT EXISTS physical_items (
                                              ...
                                              allow_pickup INTEGER NOT NULL DEFAULT 0 CHECK (allow_pickup IN (0,1))
);
...
CREATE TABLE IF NOT EXISTS digital_items (
                                             ...
                                             replacement_guarantee INTEGER NOT NULL DEFAULT 0 CHECK (replacement_guarantee IN (0,1))
);
...
CREATE TABLE IF NOT EXISTS bids (
                                    ...
                                    auto_bid INTEGER NOT NULL DEFAULT 0 CHECK (auto_bid IN (0,1)),
                                    auto_bid_limit REAL
);
